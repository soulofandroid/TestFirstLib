...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorPaddingStartAndEnd,mIndicatorPaddingBottom;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        indicator.setPadding(mIndicatorPaddingStartAndEnd,mIndicatorPaddingBottom,mIndicatorPaddingStartAndEnd,mIndicatorPaddingBottom);
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorPaddingStartAndEnd = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_paddingStartAndEnd, BannerConfig.INDICATOR_PADDING_SIZE);
        mIndicatorPaddingBottom = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_paddingBottom, BannerConfig.INDICATOR_PADDING_SIZE);
    ...
    /**
     * Set a {@link 1} that will be called for each attached page whenever
...
//            Log.d(TAG,"displayImage ："+url+",position："+i);
            if (imageLoader != null)
    ...
    private void setData() {
        ...
        //重新设置数据即可  此处 adapter.notifyDataSetChanged(); 不生效
        ...
        viewPager.setPageMargin(20);//设置页码之间的间距
        if (gravity != -1)
...
//            Log.d(TAG,"instantiateItem初始化："+position);
...
//            Log.d(TAG,"destroyItem 删除："+position);
